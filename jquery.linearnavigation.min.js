...
updateModel(goToIndex);};var goToPrevItem=function(e){var isOnFirstEl=(currentItemIndex===0||currentItemIndex===-1);var goToIndex;if(isOnFirstEl){if(options.wrap===true){goToIndex=jQuery.data(this,pluginName).length-1;}}else{goToIndex=currentItemIndex-1;}
...
$clickDelegate.on('click',function(e){updateModel($(e.target).data(pluginName).idx);});jQuery.data(this,pluginName,{installed:'true',length:numItems});}else{jQuery.data(this,pluginName).length=numItems;}
